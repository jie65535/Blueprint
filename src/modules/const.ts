...
export const EVENT_UNLOCKS = [
    {
        name: "Stone Joker",
        condition: "牌组中至少有一张石头牌",
    },
    {
        name: "Steel Joker",
        condition: "牌组中至少有一张钢铁牌",
    },
    {
        name: "Glass Joker",
        condition: "牌组中至少有一张玻璃牌",
    },
    {
        name: "Golden Ticket",
        condition: "牌组中至少有一张黄金牌",
    },
    {
        name: "Lucky Cat",
        condition: "牌组中至少有一张幸运牌",
    },
    {
        name: "Planet X",
        condition: "打出五条",
...
export const tagDescriptions: {[key:string]: string} = {
    "Uncommon Tag": "下一家商店有一张免费的罕见小丑牌。",
    "Rare Tag": "下一家商店有一张免费的稀有小丑牌。",
    "Negative Tag": "商店里的下一张基础版本小丑牌将会免费且变为负片（+1个小丑牌槽位）。",
    "Foil Tag": "商店里的下一张基础版本小丑牌将会免费且变为闪箔（+50筹码）。",
    "Holographic Tag": "商店里的下一张基础版本小丑牌将会免费且变为镭射（+10倍率）。",
    "Polychrome Tag": "商店里的下一张基础版本小丑牌将会免费且变为多彩（X1.5倍率）。",
    "Investment Tag": "击败下一个Boss盲注后获得$25。",
    "Voucher Tag": "添加一张优惠券到下一个商店。",
    "Boss Tag": "重掷下一个Boss盲注。",
    "Standard Tag": "立即免费开启一个超级标准包。",
    "Charm Tag": "立即免费开启一个超级秘术包。",
    "Meteor Tag": "立即免费开启一个超级天体包。",
    "Buffoon Tag": "立即免费开启一个超级小丑包。",
    "Handy Tag": "本赛局每打出过一次手牌获得$1。",
    "Garbage Tag": "本赛局每一次未使用的弃牌获得$1。",
    "Ethereal Tag": "立即免费开启一个幻灵包。",
    "Coupon Tag": "下一家商店内，初始小丑牌、消耗牌和补充包均为免费（$0）。",
    "Double Tag": "下一次选定的标签会额外获得一个复制品（双倍标签除外）。",
    "Juggle Tag": "下一回合手牌上限+3。",
    "D6 Tag": "下一个商店的重掷起价为$0。",
    "Top-up Tag": "生成最多2张普通小丑牌（必须有空位）。",
    "Speed Tag": "本赛局中每跳过一次盲注，可获得$5。",
    "Orbital Tag": "升级一个指定的随机牌型三个等级。",
    "Economy Tag": "资金翻倍（最高$40）。",
}
